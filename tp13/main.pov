...
#declare VIDRO_R = array[4][4] {
    {<0, 10, 10>, <0, 13, 10>, <0, 16, 10>, <0, 19, 10>},
    {<0, 9, 8>, <0, 9.3, 8>, <0, 9.6, 8>, <0, 10, 8>},
    {<0, 9, 5>, <0, 9.3, 5>, <0, 9.6, 5>, <0, 10, 5>},
    {<0, 9, 3>, <0, 9.3, 3>, <0, 9.6, 3>, <0, 10, 3>}
};

#declare VIDRO_NORMAL = array[4][4] {
    {<0, 9, 3>, <0, 9.3, 5>, <0, 9.6, 8>, <0, 10, 10>},
    {<3, 9, 3>, <3, 9.3, 5>, <3, 9.6, 8>, <3, 10, 10>},
    {<6, 9, 3>, <6, 9.3, 5>, <6, 9.6, 8>, <6, 10, 10>},
    {<9, 9, 3>, <9, 9.3, 5>, <9, 9.6, 8>, <9, 10, 10>}
};
#declare VIDRO_L = array[4][4] {
    {<9, 9, 3>, <9, 9.3, 3>, <9, 9.6, 3>, <9, 10, 3>},
    {<9, 9, 5>, <9, 9.3, 5>, <9, 9.6, 5>, <9, 10, 5>},
    {<9, 9, 8>, <9, 9.3, 8>, <9, 9.6, 8>, <9, 10, 8>},
    {<9, 10, 10>, <9, 13, 10>, <9, 16, 10>, <9, 19, 10>}
};
...
suavizar_retalho(LATA, FRENTE)
suavizar_retalho(FRENTE, VIDRO)
suavizar_retalho(VIDRO, CAPO)
suavizar_retalho(CAPO, VIDRO_TRAS)
suavizar_retalho(VIDRO_TRAS, TRAS)

// suavizar_retalho(VIDRO_R, VIDRO_L)

union{
    
    retalho(LATA, 0, tx_b1, tx_b4)
    retalho(CAPO, 0, tx_b1, tx_b4)
    retalho(VIDRO, 0, tx_b1, tx_b5)
    retalho(VIDRO, 0, tx_b1, tx_vidro)
    // retalho(VIDRO_R, 0, tx_b1, tx_b1)
    // retalho(VIDRO_L, 0, tx_b1, tx_b1)
    retalho(FRENTE, 0, tx_b1, tx_b4)
    retalho(VIDRO_TRAS, 0, tx_b1, tx_b4)
    retalho(TRAS, 0, tx_b1, tx_b4)
    // eixos(20)
}

#include "camlight.inc"
#declare centro_cena = < 10.00, 10.00, 0.00 >;
